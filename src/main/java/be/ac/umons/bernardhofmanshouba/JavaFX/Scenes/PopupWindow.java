...
import static be.ac.umons.bernardhofmanshouba.JavaFX.Scenes.SceneTool.*;
    ...
    public VBox createLayout(PopupType popupType, Label label, Stage popupWindow){
        ...
        switch (popupType){
            ...
            case END_GAME:
                ...
                restartGame.setScaleX(1.2);
                restartGame.setScaleY(1.2);
                returnToMenu.setScaleX(1.2);
                returnToMenu.setScaleY(1.2);
